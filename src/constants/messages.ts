...
export const messages: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "ui.setup.title": "Initial setup",
    "ui.setup.hint": "Enter players and total gifts",
  ...
  sv: {
    ...
    "ui.setup.title": "Initial setup",
    "ui.setup.hint": "Ange spelare och totalt antal paket",
    ...
    "ui.order.heading": "Redo",
    "ui.order.subtitle": "Spelordning",
